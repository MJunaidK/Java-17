...
//        System.out.println("# of male students "+ maleStudents.count());
        ...
        for(int i= 0; i < list.size(); i++){
            ...
            total += cnt;
            System.out.printf("# of students (%s) = %d%n", i == 0 ? "< 30" : ">= 30 & 30 < 60", cnt);
        }
        ...
        Arrays.stream(students)
                ...
                .filter(s -> !s.hasProgrammingExperience())
                .limit(5)
                .toList() //At this point this list and not a stream anymore
                .forEach(System.out::println); // foreach is a method on list and not a terminal operation on stream
