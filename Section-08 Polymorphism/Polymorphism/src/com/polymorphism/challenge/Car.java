...
class ElectricCar extends Car{
    ...
    @Override
    public void startEngine() {
        System.out.printf("BEV -> All %d cylinders are fired up", batterySize);
    }
...
class HybridCar extends Car{
    ...
    @Override
    public void startEngine() {
        System.out.printf("Hybrid -> All %d cylinders are fired up", cylinders);
        System.out.printf("Hybrid -> All %d batteries are fired up", batterySize);
    }
