package com.chainlambda.example;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat(" Khan");
        ...
        Predicate<String> p1 = s -> s.equals("MOHAMMAD JUNAID");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Mohammad Junaid");
        Predicate<String> p3 = s -> s.startsWith("M");
        Predicate<String> p4 = s -> s.endsWith("z");
